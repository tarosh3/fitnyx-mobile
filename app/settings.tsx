...
import { Bell, ChevronRight, FileText, LogOut, Moon, Shield, Sun, User } from 'lucide-react-native';
...
export default function SettingsScreen() {
  ...
  return (
    <Screen scroll={true} contentContainerStyle={styles.screenContent}>
          ...
          <Row
            ...
            right={
              <Switch
                ...
                trackColor={{ false: 'rgba(255,255,255,0.1)', true: `${neonLime}44` }}
...
function Row({
  ...
  return (
    <Pressable onPress={onPress} disabled={!onPress} style={styles.row}>
      ...
      {right || (onPress ? <ChevronRight color="rgba(255,255,255,0.3)" size={20} /> : null)}
    </Pressable>
  );
}
