  ...
  return (
    <Screen scroll={false} contentContainerStyle={styles.center}>
      <View style={[styles.card, { backgroundColor: palette.card, borderColor: palette.border }]}>
        ...
        <Text style={[styles.title, { color: palette.text }]}>Your access has expired</Text>
        <Text style={[styles.subtitle, { color: palette.mutedText }]}>
          Your workouts and progress are safe. Redeem a new invite code to pick up where you left off.
        </Text>
        <InviteRedeemForm submitLabel="Renew access" />
